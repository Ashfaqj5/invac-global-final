    ...
    <div class="w-full select-none">
        <div class="hidden bg-white lg:flex">
            <div class="w-[55%] min-h-screen max-h-screen h-screen sticky top-0">
                <div class="h-full w-full relative">
                    <img src="@/assets/products/static/techno-plus-230.png" class="h-full w-full object-cover object-center"
                        alt="" />
                    <div class="h-full w-full absolute top-0 flex flex-col justify-between">
                        ...
                        <div class="flex flex-col gap-y-10 mr-auto pl-10 2xl:pl-20">
                            ...
                            <img src="@/assets/icons/10x-powerful-cyclonic-suction.svg" class="h-16 2xl:h-24 invert"
                                alt="" />
                            <img src="@/assets/icons/twin-motor.svg" class="h-16 2xl:h-24" alt="" />
                    ...
                    <div class="w-full border-2 border-black px-2 rounded-xl py-5 2xl:py-10 mt-20">
                        ...
                        <div class="grid grid-cols-4 items-center justify-evenly pr-2 w-full px-5 2xl:px-10 pt-4">
                            <div class="flex flex-col gap-y-2 items-center">
                                ...
                                <p class="text-sm 2xl:text-lg">2</p>
                            </div>

                            <div class="flex flex-col gap-y-2 items-center">
                                <h2 class="font-semibold lg:text-xs 2xl:text-base">Amps</h2>
                                <p class="text-sm 2xl:text-lg">13.7x2</p>
                            </div>
        ...
        <div class="lg:hidden relative bg-white">
            ...
            <div class="h-[70vh] w-full">
                <img src="@/assets/products/static/techno-plus-230.png" class="h-full w-full object-cover" alt="">
            </div>
            <div class="w-full px-10 pb-10 text-black">
                ...
                <div v-else class="w-full">
                    ...
                    <NuxtLink to="/demo"
                        class="w-full border-2 flex items-center justify-center border-black mt-10 py-10 rounded-lg px-3">
...
useHead({
    title: 'Invac - Techno Plus 230',
    meta: [
        {
            name: 'description',
            content: "Most powerful machine in the range. Automatically sucks up liquids and drains directly to the sewage. Self-flushing system also provides infinite capacity and simple operation. Water injectors turn dust into sludge."
        }
    ]
})
const description = ref(
    "Most powerful machine in the range. Automatically sucks up liquids and drains directly to the sewage. Self-flushing system also provides infinite capacity and simple operation. Water injectors turn dust into sludge."
);
const triggerMenu = () => {
